...
function FriendDirections({ currentLocation, friendSelected, travelMode }) {
      ...
      directionsService.route(
        {
          ...
          destination: friendSelected.geolocation,
  ...
  }, [friendSelected, currentLocation, travelMode]);
  return (
    <>
      {friendSelected && (
        <DirectionsRenderer
...
export default FriendDirections;
